            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-description">
                        ...
                        <a href="{{ url('panel/product/create') }}" class="btn btn-primary">Add</a>
                    </p>
                                    ...
                                    @foreach ($products as $item)
                                        <tr class="item" item-id="{{ $item->id }}">
                                            ...
                                            <td class="d-flex">
                                                ...
                                                <a href="{{ url('panel/product/edit/'.$item->id) }}"
                                                    class="btn btn-primary mr-2">Edit
                                                </a>

                                                <a href="{{ url('panel/product/destroy/'.$item->id) }}"
                                                    class="btn btn-primary mr-2">Delete
                                                </a>
