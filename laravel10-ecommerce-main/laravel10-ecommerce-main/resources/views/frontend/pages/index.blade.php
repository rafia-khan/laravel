...
@section('content')
    ...
    <div class="site-section site-section-sm site-blocks-1" style="background-color: rgb(233, 228, 238)">
        <div class="container">
            <div class="row" >
    ...
    <div class="site-section site-blocks-2" style="background-color: rgb(238, 228, 228)">
        <div class="container">
            <div class="row">
    ...
    <div class="site-section block-3 site-blocks-2 " style="background-color:rgb(232, 255, 247);">
        <div class="container">
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-md-12 col-lg-7 mb-5">
                    <a href="#"><img src="{{asset('images/hero_1.png') }}" alt="Image placeholder"
                            class="img-fluid rounded"></a>
                </div>
                <div class="col-md-12 col-lg-5 text-center pl-md-5">
                    <h4>
                        <a href="{{route('product')}}">{{ $settings['campaign_title'] ?? '' }}</a>
                    </h4>
                    <p>{!! $settings['campaign_text'] ?? '' !!}</p>
                    <p><a href="{{ route('product') }}" class="btn btn-primary btn-sm">Shop Now</a></p>
                </div>
            </div>
        </div>
    </div>
